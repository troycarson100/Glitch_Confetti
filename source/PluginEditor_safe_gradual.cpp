...
// Safe gradual UI restoration - adding components one by one to identify crash source
    ...
    : AudioProcessorEditor (p), processorRef (p)
{
    ...
    // Start with minimal safe components
    setupBasicSafeComponents();
...
void PluginEditor::setupBasicSafeComponents()
{
    // Create only basic safe components first
    setupBasicKnobs();
    setupBasicStepButtons();
}
...
void PluginEditor::setupBasicStepButtons()
{
...
void PluginEditor::layoutBasicComponents()
{
...
{
    // Set basic colors
    setColour(juce::Button::buttonColourId, juce::Colours::darkgrey);
    setColour(juce::Button::buttonOnColourId, juce::Colours::yellow);
}

void CustomStepButton::paintButton(juce::Graphics& g, bool isMouseOverButton, bool isButtonDown)
{
    // Use default JUCE button painting - this is guaranteed to work
