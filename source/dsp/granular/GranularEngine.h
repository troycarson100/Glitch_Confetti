...
private:
    // Configuration
    static constexpr float kCaptureSec = 2.0f;  // Further reduced to 2s for better performance
    static constexpr int kMaxVoices = 32;       // Further reduced to 32 voices max
