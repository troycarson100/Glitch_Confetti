...
xcodebuild -project build-universal/Stepper.xcodeproj -scheme Stepper_Standalone -configuration Debug build
...
# Build AU
echo "Building AU..."
xcodebuild -project build-universal/Stepper.xcodeproj -scheme Stepper_AU -configuration Debug build
...
echo ""
echo "Standalone: build-universal/Stepper_artefacts/Release/Standalone/Stepper.app"
